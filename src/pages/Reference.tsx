        ...
        <div className="container px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              <span className="heading-hero">Reference</span>
              <span className="text-foreground"> a </span>
              <span className="heading-accent">spolupráce</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Spolupracujeme s firmami a týmy, které chtějí pracovat chytřeji. 
              Pomáháme jim zavádět AI nástroje, školíme praktické dovednosti 
              a navrhujeme automatizaci na míru.
            </p>
          </div>
        </div>
      </section>
