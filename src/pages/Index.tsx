...
const deliverables = [
  {
    ...
    description: "Automatizované zápisy z jednání (MoM) s integrací do vašich systémů.",
    accent: "cyan",
  },
  {
    icon: BarChart3,
    title: "PRŮMYSLOVÁ ANALYTIKA",
    description: "AI agenti pro optimalizaci logistiky a výrobní simulace.",
    accent: "cyan",
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description: "Firemní modely s nulovou chybovostí díky metodice Few-Shot Prompting.",
    accent: "purple",
  },
];
    ...
    <>
      ...
      <div className="min-h-screen flex flex-col relative z-10">
        ...
        <main className="flex-1">
          {/* Hero Section */}
          <section aria-labelledby="hero-heading" className="flex items-center justify-center pt-[180px] md:pt-[200px] pb-20 md:pb-24">
              ...
              <div className="max-w-[950px] mx-auto">
                ...
                <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-primary/5 border border-primary/40 mb-12 shadow-[0_0_20px_rgba(102,252,241,0.15)]">
                  <span className="text-[10px] md:text-xs font-semibold tracking-[0.2em] text-primary uppercase">
                    Strategický partner pro průmysl a regulovaná odvětví
                  </span>
                </div>
                ...
                <h1 
                  id="hero-heading" 
                  className="text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold mb-10 leading-tight tracking-[0.18em] uppercase"
                >
                  <span className="block text-white drop-shadow-[0_0_30px_rgba(102,252,241,0.12)]">
                    TRANSFORMUJEME KOMPLEXITU
                  </span>
                  <span 
                    className="block mt-2 hero-gradient-text drop-shadow-[0_0_40px_rgba(102,252,241,0.2)]"
                  >
                    V SYSTÉMOVOU AUTONOMII
                  </span>
                </h1>
                
                {/* Subheadline - The Professional Hook */}
                <p className="text-base md:text-lg lg:text-xl text-muted-foreground max-w-[850px] mx-auto mb-14 normal-case tracking-normal leading-relaxed">
                  Implementujeme AI řešení s nekompromisním respektem k bezpečnosti a vašim standardům, s důrazem na měřitelnou návratnost (ROI). Jan Bouda navrhuje architekturu systému, Daniel Červený vede strategii a administrativní proces k 82–100% dotačnímu financování.
                </p>
