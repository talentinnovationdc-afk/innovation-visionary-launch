          ...
          <section id="services" aria-labelledby="services-heading" className="py-20 md:py-28">
            <div className="container px-4">
              <div className="text-center mb-16">
                <h2 id="services-heading" className="text-2xl md:text-3xl lg:text-4xl font-semibold tracking-[0.2em] text-foreground uppercase">
                  NAŠE SLUŽBY
                </h2>
              </div>
                ...
                {services.map((service, index) => (
                  ...
                  >
                    <div className="flex items-start gap-5">
                      <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-primary/10 border border-primary/20 flex items-center justify-center group-hover:bg-primary/20 transition-colors duration-300" aria-hidden="true">
