        ...
        <div className="container px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8">
              ...
              <span className="text-sm text-primary font-medium">AI vzdělávání pro firmy</span>
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Transformujte svůj tým pomocí{" "}
              <span className="gradient-text">AI vzdělávání</span>
            </h1>
            
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
              Posílíme váš tým nejnovějšími AI dovednostmi. Dodáváme školení na míru, která přinášejí měřitelné obchodní výsledky.
            </p>
